...
function createUserRowContent(userRow, user) {
  ...
  createElement('input', { type: 'button', value: 'View', 'data-action': 'view', className: 'btn btn-primary' }, '', divButtons);
  createElement('input', { type: 'button', value: 'Edit', 'data-action': 'edit', className: 'btn btn-warning' }, '', divButtons);
  createElement('input', { type: 'button', value: 'Delete', 'data-action': 'delete', className: 'btn btn-danger' }, '', divButtons);
}
